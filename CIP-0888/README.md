...
This proposal defines a metadata standard for Soulbound Tokens making use of output datums.

## Motivation: why is this CIP necessary?

This proposal extends both [CIP-0067](https://github.com/cardano-foundation/CIPs/blob/master/CIP-0067) and [CIP-0068](https://github.com/cardano-foundation/CIPs/blob/master/CIP-0068) to introduce Soulbound Tokens to Cardano.
